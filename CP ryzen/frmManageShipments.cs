...
namespace ShippingManagementSystem
{
    public partial class frmManageShipments : Form
    {
        ...
        private void btnAddShipment_Click(object sender, EventArgs e)
        {
            try
            {
                // Using the correct CreateShipment signature
                int shipmentId = shipmentManager.CreateShipment(
                    "New Shipment - Click Edit to modify",  // description
                    "To be determined",                      // destination
                    "",                                      // origin
                    DateTime.Now,                            // dateShipped
                    DateTime.Now.AddDays(5),                // estimatedArrival
                ...
                if (shipmentId > 0)
                {
                    ...
                    // Create shipment object for email
        ...
        private void btnSaveEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Using the correct UpdateShipment signature
                bool success = shipmentManager.UpdateShipment(
                    selectedShipment.ID,                    // shipmentId
                    txtEditDescription.Text.Trim(),         // description
                    cmbEditStatus.SelectedItem.ToString(),  // status
                    txtEditDestination.Text.Trim(),         // destination
                    dtpEditDateShipped.Value,               // dateShipped
                    dtpEditEstimatedArrival.Value,          // estimatedArrival
                    null                                    // role (optional)
                );
        ...
        {
            // Duplicate event handler - can be removed or calls frmManageShipments_Load
